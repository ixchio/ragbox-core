...
[![CI](https://github.com/amankumarpandeyin/ragbox-core/actions/workflows/ci.yml/badge.svg)](https://github.com/amankumarpandeyin/ragbox-core/actions/workflows/ci.yml)
...
We welcome contributions to RAGBox-Core! Please see our [CONTRIBUTING.md](CONTRIBUTING.md) for details on how to set up your development environment, run the test suite, and submit Pull Requests.
