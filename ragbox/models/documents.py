...
class CodeDocument(Document):
    ...
    ast_nodes: List[Dict[str, Any]] = Field(default_factory=list, description="Tree-sitter parsed AST")
...
class StructuredDocument(Document):
    ...
    schema_inferred: Dict[str, Any] = Field(default_factory=dict, description="Inferred schema")
