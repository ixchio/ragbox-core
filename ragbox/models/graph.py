...
class Entity(BaseModel):
    ...
    entity_type: str = Field(description="Inferred type of the entity (e.g. PERSON, ORG)")
...
class Community(BaseModel):
    ...
    entity_ids: List[str] = Field(default_factory=list, description="Entities in this community")
    summary: str = Field(default="", description="LLM-generated summary of the community")
